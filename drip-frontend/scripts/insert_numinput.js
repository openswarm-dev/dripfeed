...
console.log('Inserting NumInput before line', waveIdx + 1);

const numInputCode = `// \u2500\u2500\u2500 Custom number input with +/- buttons \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
...
lines.splice(waveIdx, 0, numInputCode);
fs.writeFileSync('app/page.tsx', lines.join('\n'), 'utf8');
console.log('Done. NumInput component added.');
